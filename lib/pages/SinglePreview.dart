...
class _SinglePreviewState extends State<SinglePreview> {
  textFormViewer(String _hintText, String _hintContent) => Material(
      elevation: 5.0,
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
        child: Container(
            ...
            padding: context.isMobile ? EdgeInsets.all(20) : EdgeInsets.all(50),
            child: Column(
              children: [
                Center(
                    child: Text("Preview ",
                ...
                textFormViewer("Application Id",
                    global.dataPreview['applicationId'].toString()),
                ...
                const SizedBox(height: 20.0),
                textFormViewer(
                    "Date Of Birth", global.dataPreview['dob&pass'].toString()),
                const SizedBox(height: 20.0),
                textFormViewer(
                    "Gender", global.dataPreview['gender'].toString()),
                const SizedBox(height: 20.0),
                textFormViewer(
                    "Course", global.dataPreview['course'].toString()),
                const SizedBox(height: 20.0),
                ...
                const SizedBox(height: 20.0),
                textFormViewer(
                    "Post Office ", contact["postOffice"].toString()),
                const SizedBox(height: 20.0),
                ...
                const SizedBox(height: 20.0),
                textFormViewer("Father Occupation",
                    contact["fatherOccupation"].toString()),
                const SizedBox(height: 20.0),
                textFormViewer("Father PhoneNumber",
                    contact["fatherPhoneNumber"].toString()),
                const SizedBox(height: 20.0),
                textFormViewer("10th Mark", contact["10thMark"].toString()),
                const SizedBox(height: 20.0),
                textFormViewer(
                    "10th School Name", contact["10thSchoolName"].toString()),
                const SizedBox(height: 20.0),
                textFormViewer(
                    "Annual Income", contact["annualIncome"].toString()),
                const SizedBox(height: 20.0),
                textFormViewer(
                ...
                textFormViewer(
                    "12th Stream", education["_12thStream"].toString()),
                const SizedBox(height: 20.0),
                textFormViewer(
                    "12th Passig Year", education["_12PassingYear"].toString()),
                const SizedBox(height: 20.0),
                textFormViewer("12th Register Number",
                    education["_12registerNumber"].toString()),
                const SizedBox(height: 20.0),
                textFormViewer("12th Institution Name",
                    education["_12institutionName"].toString()),
                const SizedBox(height: 20.0),
                textFormViewer(
                    "12th Score", education["_12markObtained"].toString()),
                const SizedBox(height: 20.0),
                textFormViewer(
                    "12th Percentage", education["_12percentage"].toString()),
                const SizedBox(height: 20.0),
                textFormViewer(
                    "Maths Score", education["_mathsSubMark"].toString()),
                const SizedBox(height: 20.0),
                textFormViewer(
                    "Physics Score", education["_physicsSubMark"].toString()),
                const SizedBox(height: 20.0),
                textFormViewer("Chemistry Score",
                    education["_chemistrySubMark"].toString()),
                const SizedBox(height: 20.0),
                textFormViewer("Entrance", education["_entrance"].toString()),
                const SizedBox(height: 20.0),
                textFormViewer(
                    "Entrance Year", education["_entranceYear"].toString()),
                const SizedBox(height: 20.0),
                textFormViewer(
                    "Entrance Rank", education["_entranceRank"].toString()),
                const SizedBox(height: 20.0),
                textFormViewer("Entrance Application Number",
                    education["_entranceApplicationNumbe"].toString()),
                const SizedBox(height: 50.0),
