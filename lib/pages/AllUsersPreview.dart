                      ...
                      .map(
                        ((element) => DataRow(
                              cells: <DataCell>[
                                ...
                                DataCell(Text(element["contactDetails"]["houseName"].toString())),
                                DataCell(Text(element["contactDetails"]["postOffice"].toString())),
                                DataCell(Text(element["contactDetails"]["panchayat"].toString())),
                                DataCell(Text(element["contactDetails"]["district"].toString())),
                                DataCell(Text(element["contactDetails"]["state"].toString())),
                                DataCell(Text(element["contactDetails"]["pinCode"].toString())),
                                DataCell(Text(element["contactDetails"]["fatherName"].toString())),
                                DataCell(Text(element["contactDetails"]["fatherOccupation"].toString())),
                                DataCell(Text(element["contactDetails"]["fatherPhoneNumber"].toString())),
                                DataCell(Text(element["contactDetails"]["10thMark"].toString())),
                                DataCell(Text(element["contactDetails"]["10thSchoolName"].toString())),
                                DataCell(Text(element["contactDetails"]["annualIncome"].toString())),
                                DataCell(Text(element["contactDetails"]["nationality"].toString())),
                                DataCell(Text(element["contactDetails"]["religion"].toString())),
                                DataCell(Text(element["contactDetails"]["caste"].toString())),

                                DataCell(Text(element["educationDetails"]["_12thStream"].toString())),
                                DataCell(Text(element["educationDetails"]["_12PassingYear"].toString())),
                                DataCell(Text(element["educationDetails"]["_12registerNumber"].toString())),
                                DataCell(Text(element["educationDetails"]["_12institutionName"].toString())),
                                DataCell(Text(element["educationDetails"]["_12markObtained"].toString())),
                                DataCell(Text(element["educationDetails"]["_12percentage"].toString())),
                                DataCell(Text(element["educationDetails"]["_mathsSubMark"].toString())),
                                DataCell(Text(element["educationDetails"]["_physicsSubMark"].toString())),
                                DataCell(Text(element["educationDetails"]["_chemistrySubMark"].toString())),
                                DataCell(Text(element["educationDetails"]["_entrance"].toString())),
                                DataCell(Text(element["educationDetails"]["_entranceYear"].toString())),
                                DataCell(Text(element["educationDetails"]["_entranceRank"].toString())),
                                DataCell(Text(element["educationDetails"]["_entranceApplicationNumbe"].toString())),

                                DataCell(Text(element["coursePref"]["p1"].toString())),
                                DataCell(Text(element["coursePref"]["p2"].toString())),
                                DataCell(Text(element["coursePref"]["p3"].toString())),
